...
MICROPYTHON_EMBED_PORT = port/

# Set default makefile-level MicroPython feature configurations.
MICROPY_ROM_TEXT_COMPRESSION ?= 0

# Set CFLAGS for the MicroPython build.
CFLAGS += -I. -I$(TOP) -I$(BUILD) -I$(MICROPYTHON_EMBED_PORT) -I../freertos/include -I/home/michele/Software/Carbon/CM7/conf -I../freertos/portable/GCC/ARM_CM7/r0p1
...
PACKAGE_DIR_LIST = $(addprefix $(PACKAGE_DIR)/,py extmod shared/runtime genhdr)
